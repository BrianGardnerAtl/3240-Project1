...
public class NfaStruct{
  ...
  private ArrayList<NfaNode> finalStates = new ArrayList<NfaNode>();
  ...
  public boolean addNode(NfaNode node, String transition){
    ...
    if(node.isFinal() && !allNodes.contains(node)){
  ...
  public void setStart(NfaNode ns){
	  this.setCurrent(ns.getIdentifier());
	  this.addNode(ns,"epsilon");
	  
	  start = ns;
  }

  public ArrayList<NfaNode> getFinal(){
    return finalStates;
  }
  
  public void setFinal(ArrayList<NfaNode> finalStates) {
